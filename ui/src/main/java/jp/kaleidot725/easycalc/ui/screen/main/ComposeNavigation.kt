...
sealed interface ComposeNavigation {
    ...
    data class Category(val category: MathText.Category = MathText.Category.ADDITION) : ComposeNavigation {
    ...
    data class Result(private val text: MathText? = null, private val qalist: QAList? = null) : ComposeNavigation {
