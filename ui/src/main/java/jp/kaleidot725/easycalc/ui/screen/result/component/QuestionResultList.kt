package jp.kaleidot725.easycalc.ui.screen.result.component
...
import jp.kaleidot725.easycalc.ui.screen.common.HorizontalDivider
...
private fun QuestionResultList_Preview() {
    val qaList = QAList().apply {
        add(
            Question(100.toString(), 200.toString(), 300.toString(), MathText.Category.ADDITION),
            Answer.Success(300.toString(), 0.toString())
        )
        add(
            Question(100.toString(), 200.toString(), 300.toString(), MathText.Category.ADDITION),
            Answer.Failed(200.toString(), 0.toString())
        )
        add(
            Question(100.toString(), 200.toString(), 300.toString(), MathText.Category.ADDITION),
            Answer.Success(300.toString(), 0.toString())
        ...
        add(
            Question(100.toString(), 200.toString(), 300.toString(), MathText.Category.ADDITION),
            Answer.Failed(400.toString(), 0.toString()),
        )
    }
