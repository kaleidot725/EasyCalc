package jp.kaleidot725.easycalc.domain.model.question.generator.division
...
internal data class DivisionRemainderGenerator(
    ...
    override fun generate(): Question {
        while (true) {
            ...
            val multipleCandidates = (2..max).map { number -> number * targetDivisionNumber }.filter { it in min..max }
