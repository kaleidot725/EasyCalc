...
//    }
    ...
    override suspend fun addTodayStats(epochSeconds: Long, solvedQuizCount: Long) {
        val current = todayStatsDao.getById(getTodayId()) ?: TodayStatsEntity(getTodayId(), 0, 0)
    ...
    private fun getTodayId(): String {
        ...
        return getSortableId(localDateTime.year, localDateTime.monthNumber, localDateTime.dayOfMonth)
    }
