...
import jp.kaleidot725.easycalc.core.domain.model.question.generator.addition.DoubleDigitAdditionGenerator
import jp.kaleidot725.easycalc.core.domain.model.question.generator.addition.SingleDigitAdditionGenerator
import jp.kaleidot725.easycalc.core.domain.model.question.generator.addition.TripleDigitAdditionGenerator
import jp.kaleidot725.easycalc.core.domain.model.question.generator.division.DivisionGenerator
import jp.kaleidot725.easycalc.core.domain.model.question.generator.division.DivisionRemainderGenerator
import jp.kaleidot725.easycalc.core.domain.model.question.generator.multiplication.DoubleDigitMultiplicationGenerator
import jp.kaleidot725.easycalc.core.domain.model.question.generator.multiplication.MultiplicationTableGenerator
import jp.kaleidot725.easycalc.core.domain.model.question.generator.multiplication.SingleDigitMultiplicationGenerator
import jp.kaleidot725.easycalc.core.domain.model.question.generator.multiplication.TripleDigitMultiplicationGenerator
import jp.kaleidot725.easycalc.core.domain.model.question.generator.subtraction.DoubleDigitSubtractionGenerator
import jp.kaleidot725.easycalc.core.domain.model.question.generator.subtraction.SingleDigitSubtractionGenerator
import jp.kaleidot725.easycalc.core.domain.model.question.generator.subtraction.TripleDigitSubtractionGenerator
...
class QuestionSelectorImpl : QuestionSelector {
    override fun select(text: MathText): QuestionGenerator {
        return when (text) {
            ...
            MathText.TripleDigitsDivisionRemainder -> DivisionRemainderGenerator(
                min = 100,
                max = 999
            )
